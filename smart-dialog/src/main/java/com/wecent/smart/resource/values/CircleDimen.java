...
public class CircleDimen {
     ...
     * 文本对话框的内容高度
     */
    public static int MESSAGE_HEIGHT = 180;
    /**
     * 标题字体大小
     */
     ...
     * 文字消息字体大小
     */
    public static int MESSAGE_TEXT_SIZE = 50;
    /**
     * 列表item字体大小
     */
     ...
     * 列表每行高度
     */
    public static int ITEM_HEIGHT = 150;
    /**
     * 底部按钮高度
     */
     ...
     * 底部按钮字体大小
     */
    public static int FOOTER_BUTTON_TEXT_SIZE = 50;
    /**
     * 列表模式底部按钮与列表的距离
     */
     ...
     * 文本对话框的内间距
     */
    public static int[] MESSAGE_PADDING = {50, 50, 50, 50};
    /**
     * 副标题文字内间距
     */
